...
// Config
angular.module('ngCsvDropbox.config', []).
  value('ngCsvDropbox.config', {
      debug: true
  }).
...
// Modules
angular.module('ngCsvDropbox.directives', ['ngCsvDropbox.services']);
angular.module('ngCsvDropbox.services', []);
angular.module('ngCsvDropbox',
    [
        'ngCsvDropbox.config',
        'ngCsvDropbox.services',
        'ngCsvDropbox.directives',
        'ngSanitize'
    ]);

// Common.js package manager support (e.g. ComponentJS, WebPack)
if (typeof module !== 'undefined' && typeof exports !== 'undefined' && module.exports === exports) {
  module.exports = 'ngCsvDropbox';
}
/**
 ...
 */
angular.module('ngCsvDropbox.directives').
  directive('ngCsvDropbox', ['$parse', '$q', 'CSV', '$document', '$timeout', function ($parse, $q, CSV, $document, $timeout) {
    return {
      restrict: 'AC',
      scope: {
        data: '&ngCsvDropbox',
      ...
      controller: [
        ...
        function ($scope, $element, $attrs, $transclude) {
          ...
          $scope.buildCSV = function () {
            ...
            $element.addClass($attrs.ngCsvDropboxLoadingClass || 'ng-csv-loading');

            CSV.stringify($scope.data(), getBuildCsvOptions()).then(function (csv) {
              $scope.csv = csv;
              $element.removeClass($attrs.ngCsvDropboxLoadingClass || 'ng-csv-loading');
          ...
          // });
      		...
      		client.authenticate(function(error, client){
      			if(error){
      				...
      				console.log(client);
      				client.writeFile('BudgieData.csv',scope.csv,function(error, stat){
                if(error){
